...
TENSR_MODULES := $(addprefix tensr/, \
					...
					$(addprefix alloc/, tensr_alloc.c tensr_copy.c tensr_linspace.c tensr_broadcast.c tensr_reduced.c tensr_from_data.c tensr_get.c tensr_set.c tensr_scalar.c tensr_full.c ) \
