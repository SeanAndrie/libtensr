...
NAME := libtensr.a
CC := cc
CFLAGS := -Wall -Werror -Wextra -Iincludes -Iincludes/utils/ -Iincludes/tensr_core -Iincludes/tensr_rt -I../libft/includes -O3 -ffast-math -flto -funroll-loops -fno-signed-zeros
ARCHIVE := ar rcs
