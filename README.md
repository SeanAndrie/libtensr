...
The library depends on the <a href='https://github.com/SeanAndrie/libft-adapt'>libft-adapt</a>
 library, which provides foundational utility functions, and should be placed in the root directory alongside it to ensure proper compilation and linkage.
